...
def home():
	...
	if request.method == 'POST' and form.validate():
		...
		destination = main_function(form.oneDollar.data, form.twoDollar.data, form.threeDollar.data, form.fourDollar.data, meters, form.numFriends.data)
...
@app.route('/lyft')
def lyft():
    return render_template('lyft.html', myeta=estimates.get_eta, myridetype=estimates.get_ride_type, myduration=estimates.get_duration, mydistance=estimates.get_distance, mymax=estimates.get_price_max, mymin=estimates.get_price_min) 
